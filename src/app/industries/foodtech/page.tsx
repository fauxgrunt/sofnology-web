          ...
          {helpModes.map((mode, index) => {
            ...
            return (
              <article
                ...
                tabIndex={0}
                className={`min-h-[300px] cursor-pointer border-neutral-200 px-6 py-9 transition-colors duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] md:px-8 lg:px-10 ${
          ...
          {productSurfaces.map((surface, index) => {
            ...
            return (
              <article
                ...
                tabIndex={0}
                className={`min-h-[300px] cursor-pointer border-white/14 px-6 py-9 transition-colors duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] md:px-8 lg:px-10 ${
                  index > 0 ? "border-t md:border-t-0 md:border-l" : ""
    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          <a
            href="#contact-form"
            className="pointer-events-auto mx-auto flex h-14 max-w-md items-center justify-between gap-4 px-5 text-[15px] font-semibold tracking-[-0.03em] text-white shadow-[0_12px_40px_rgba(27,58,42,0.28)] md:h-16 md:max-w-lg md:px-6 md:text-base"
            style={{ backgroundColor: DEEP }}
          >
