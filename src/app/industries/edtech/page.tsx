        ...
        <div className="relative min-h-[520px] overflow-hidden border-b border-neutral-200 md:min-h-[580px] lg:min-h-[640px]">
          ...
          <div className="relative flex h-full min-h-[520px] items-end px-6 py-14 md:min-h-[580px] md:px-10 lg:min-h-[640px] lg:items-center lg:px-16">
            <div className="max-w-xl text-white">
              ...
              <h1 className="mt-5 text-4xl leading-[1.05] font-semibold tracking-[-0.055em] md:text-5xl lg:text-[3.5rem]">
    ...
    <section className="border-b border-neutral-200 bg-[#f4f4f4]">
      <div className="mx-auto max-w-[1440px] border-x border-neutral-200">
        <div className="grid grid-cols-1 lg:grid-cols-[0.34fr_0.66fr]">
          <a
            href="#contact-form"
            className="group relative flex min-h-[280px] flex-col justify-between px-6 py-8 text-neutral-950 transition-opacity hover:opacity-95 md:px-8 lg:min-h-[380px] lg:px-10"
            style={{ backgroundColor: MAGENTA }}
          >
    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          <a
            href="#contact-form"
            className="pointer-events-auto mx-auto flex h-14 max-w-lg items-center justify-between gap-4 px-5 text-[14px] font-semibold tracking-[-0.03em] shadow-[0_12px_40px_rgba(18,36,28,0.22)] md:h-16 md:max-w-xl md:px-6 md:text-[15px]"
            style={{ backgroundColor: MINT, color: DEEP }}
          >
