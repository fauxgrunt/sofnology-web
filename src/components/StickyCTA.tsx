    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-3 pb-[max(0.65rem,env(safe-area-inset-bottom))] md:px-6 md:pb-[max(1.1rem,env(safe-area-inset-bottom))]"
        >
          <a
            href={href}
            className="tap-press pointer-events-auto mx-auto flex h-[3.25rem] max-w-lg items-center justify-between gap-4 px-5 text-[15px] font-semibold tracking-[-0.03em] shadow-[0_14px_40px_rgba(16,20,19,0.18)] md:h-16 md:max-w-xl md:px-6 md:text-base"
