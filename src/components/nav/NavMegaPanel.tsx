  ...
  return (
    ...
    >
      ...
      >
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-y-0 -left-1/4 w-1/4 skew-x-[-18deg] bg-white/35 opacity-0 transition-all duration-400 group-hover:left-[115%] group-hover:opacity-100"
        />
        <span className="relative z-10">{promo.cta}</span>
        <span className="relative z-10 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" aria-hidden="true">
          ↗
        </span>
      </a>
    </motion.div>
...
function BottomBanner({
  ...
  return (
    <motion.a
      ...
      initial="hidden"
      animate="visible"
      className="group col-span-12 mt-2 flex min-h-[72px] items-center justify-between gap-6 border-t border-neutral-300/70 bg-[#061a3a] px-6 py-5 font-nav text-white transition-opacity hover:opacity-95 md:px-8"
    >
