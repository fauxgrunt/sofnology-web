...
export default function PrimaryCTA({ fullWidth = false, onClick }: PrimaryCTAProps) {
  return (
    <Link
      href="/#contact"
      onClick={onClick}
      className={`group relative flex items-center justify-center overflow-hidden bg-[#061a3a] font-nav text-fluid-cta font-medium tracking-normal text-white whitespace-nowrap transition-colors duration-300 hover:bg-[#0b2a5b] tap-press ${
